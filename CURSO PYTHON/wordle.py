...
class Wordle(Frame):
	...
	def create_widgets(self):
		self.frame_titulo = Frame(self.master, bg='black', width=550, height=100)
		self.frame_titulo.grid_propagate(0)
		self.frame_titulo.grid(column=0, row=0, sticky='snew')
		self.frame_cuadros = Frame(self.master, bg='black', width=550, height=450)
		self.frame_cuadros.grid_propagate(0)
		self.frame_cuadros.grid(column=0, row=1, sticky='snew')
		self.frame_control = Frame(self.master, bg='black', width=550, height=100)
...
if __name__ == "__main__":
	...
	ventana.geometry('600x600+600+50')
